...
## [Unreleased](https://codeberg.org/cosray/cms/compare/0.1.1...HEAD)
...
- **Changed** error integration to use `Celemas\Core\Error` instead of the separate `celemas/error` package; custom error renderers must implement `Celemas\Core\Error\Renderer`.
