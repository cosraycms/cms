...
// The + that puts a new block before or after the row it sits in. One
// offered type inserts at once; several open the type picker.
...
<?php if ($single !== null): ?>
	<button
		type="button"
		class="inserter is-<?= $this->escape($insert) ?>"
...
<?php else: ?>
	<details class="inserter picker is-<?= $this->escape($insert) ?>" data-repeater-menu>
